...
SEARCH_AGENT = "phi3:latest"
QUERY_AGENT = "llama3.1:8b"
VALIDATE_AGENT = "phi3:latest"
CONTAINS_AGENT = "llama3.1:8b"
ASSIST = "gemma2:2b"
...
def search_or_not():
    ...
    response = ollama.chat(model=SEARCH_AGENT, messages=[{'role': 'system', 'content': sys_msg},assistant_convo[-1]])
...
def stream_assistant_response():
    ...
    response_stream = ollama.chat(model=ASSIST, messages=assistant_convo, stream=True, options={"num_ctx": 8192})
    complete_response = ''
    print(  f'\n{ASSIST}: ')
...
def main():
    ...
    while True:
        print(Fore.LIGHTYELLOW_EX + 'WebSearch Agent: Type "exit" to quit the program.')
